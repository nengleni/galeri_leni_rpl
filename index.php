        ...
        <div class="container-sm mt-5">
            <div class="card bg-light center">
                <div class="card-header">
                    <h4 class="fs-4">Selamat Datang di Website Galeri Foto</h4>
                </div>
                <div class="card-body">
                    <p class="fs-5">Selamat datang Website! Kami senang Anda bergabung. Mari bersama-sama berbagi,
                        belajar, dan menciptakan pengalaman positif bersama.</p>
                </div>
            </div>
        </div>
    </div>
